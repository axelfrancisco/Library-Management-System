  ...
  <div class="admin-layout">
    <div class="sidebar">
      ...
      <nav class="nav-links">
        ...
        <a href="../Borrowed/borrowed.php" class="nav-item active"><i class="fa-solid fa-book-open-reader"></i> Borrowed</a>
    ...
    <main class="page-container">
      <div class="page-header">
        ...
        <p>View and force-return borrowed books.</p>
      </div>

      <div class="toolbar">
        <input type="text" id="borrowedSearch" placeholder="Search borrowed books..." />
      </div>
